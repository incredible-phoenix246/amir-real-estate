      ...
      <div className="container mx-auto px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-12">
          ...
          <p className="mb-8 text-lg text-gray-600">
            ...
            commitment to client satisfaction and excellence in property
            services.
          </p>
        ...
        <div className="mt-12">
          <p className="mb-4 text-lg text-gray-600">
            Whether you&apos;re looking for a home, an investment opportunity,
            or professional property management,{' '}
            <span className="font-semibold">AmirRealtors24</span> is here to
            make your real estate journey a success. Let&apos;s find your
